...
namespace octet {
  ...
  public:
    ...
    void draw_world(int x, int y, int w, int h) {
      ...
      float randomFeedR = ((float)(rand()%256)) / 256.0f;
      float randomFeedG = ((float)(rand()%256)) / 256.0f;
      float randomFeedB = ((float)(rand()%256)) / 256.0f;
      tolga_shader_.render(modelToProjection, randomFeedR, randomFeedG, randomFeedB);
